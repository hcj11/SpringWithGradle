...
public class ScheduleJob extends QuartzJobBean {
    ...
    protected void executeInternal(JobExecutionContext context) throws JobExecutionException {
        ...
        Assert.isTrue(o1 != null, "����Ϊ��");
        System.out.println(o1);
        // ScheduleJobEntity(jobId=5, beanName=createStatsJob, params=, cronExpression=0 0 19 * * ?, status=0, remark=��ʱ���ɼ������, createTime=Fri Dec 27 09:56:23 CST 2019)
        String substring = o1.toString();
        ClassLoader classLoader = o1.getClass().getClassLoader();
        ClassLoader contextClassLoader = Thread.currentThread().getContextClassLoader();

        if (o1 instanceof MessageDto) {
            logger.info("yes , ͬһ��ʵ��");
        }
