...
@ContextConfiguration(classes={TestAnnoationWithClassDirtiesBySpringRunner.Dummy.class})
@DirtiesContext
public class TestAnnoationWithClassDirtiesBySpringRunner implements InitializingBean {
    ...
    public void demo2(){
        ...
        Assertions.assertEquals(name,"hcj");
